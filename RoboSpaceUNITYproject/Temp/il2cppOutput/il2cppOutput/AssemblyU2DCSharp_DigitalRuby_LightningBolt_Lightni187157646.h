...
struct  LightningBoltAnimationMode_t187157646 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(LightningBoltAnimationMode_t187157646, ___value___1)); }
